...
export default function SignUpPage() {
  ...
  return (
    <div className="bg-background relative min-h-svh w-full place-items-center overflow-hidden p-4 md:grid">
      {/* fondo decorativo */}
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="from-primary/30 via-primary/10 absolute -top-24 -left-24 h-72 w-72 rounded-full bg-gradient-to-br to-transparent blur-3xl" />
        <div className="absolute -right-24 -bottom-24 h-72 w-72 rounded-full bg-gradient-to-tr from-fuchsia-400/20 via-sky-300/10 to-transparent blur-3xl" />
        <div className="bg-[radial-gradient(circle_at_1px_1px,theme(colors.muted/40)_1px,transparent_1px)] absolute inset-0 [background-size:18px_18px]" />
      </div>
      ...
      >
        <Card className="bg-card/70 overflow-hidden border-white/10 backdrop-blur-xl">
          <CardContent className="grid p-0 md:grid-cols-2">
              ...
              <div className="flex flex-col gap-6">
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="text-muted-foreground hover:text-foreground absolute inset-y-0 right-2 grid place-items-center rounded-md px-2 transition"
                      >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button variant="outline" type="button" onClick={() => signIn('google')}>
                    {' '}
                    <IconoGoogle className="mr-2 h-5 w-5" /> Google
                  </Button>
                  <Button variant="outline" type="button" onClick={() => signIn('github')}>
                    {' '}
                    <IconoGitHub className="mr-2 h-5 w-5" /> GitHub
                  </Button>
                </div>
            ...
            <div className="bg-muted hidden h-full w-full flex-col items-center justify-center gap-6 p-8 md:flex">
              ...
              <div className="bg-background/70 w-full max-w-xs rounded-xl border p-4 text-sm shadow-sm backdrop-blur">
                <p className="font-medium">¿Por qué pedimos contraseña fuerte?</p>
                <p className="text-muted-foreground">
                  Protege tu cuenta frente a ataques de fuerza bruta y credenciales filtradas.
                </p>
              </div>
            </div>
          </CardContent>
