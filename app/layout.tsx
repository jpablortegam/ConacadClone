...
export const metadata: Metadata = {
  ...
  description: "Plataforma educativa líder en cursos online. Aprende con expertos, obtén certificaciones y desarrolla nuevas habilidades desde cualquier lugar.",
  keywords: [
    "educación",
    "aprendizaje",
    "cursos online",
  ...
  openGraph: {
    ...
    description: "Plataforma educativa líder en cursos online. Aprende con expertos y desarrolla nuevas habilidades.",
